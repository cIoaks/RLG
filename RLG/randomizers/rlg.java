...
public class rlg {
    ...
    public static void Run()
    {
        ...
        //Combat Medallions
        String SIPHON = "Siphon Medallion (Hades)";
        String COMBAT = "Combat Medallion (Ares)";
        //Movement Medallions
        String SPEED = "Speed Medallion (Zeus)";
        String AGILITY = "Agility Medallion (Cerberus)";
        ...
        while (x != 0) {
            ...
            System.out.println(ANSI_BRIGHTRED + "EXIT" + ANSI_RESET + ", to exit the program.");
            System.out.println("No, will return to main menu.");
            System.out.print("Generate a loadout? (" + ANSI_NEONGREEN + "Y" + ANSI_RESET + "/" + ANSI_BRIGHTRED + "N" + ANSI_RESET + "): ");
            ...
            if (alpha.equals("Y")) {
                ...
                if (CombatMedallion == 1) {
                    System.out.println("Combat Medallion: " + SIPHON);
                }
                else if (CombatMedallion == 2){ 
                    System.out.println("Combat Medallion: " + COMBAT);
                }
    
                int MovementMedallion = rand.nextInt(2) + 1;
                if (MovementMedallion == 1) {
                    System.out.println("Movement Medallion: " + SPEED);
                }
                else if (MovementMedallion == 2) {
                    System.out.println("Movement Medallion: " + AGILITY);
                }
